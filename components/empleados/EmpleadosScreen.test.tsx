...
// useAuthedMutation se llama dos veces en el componente (deactivateEmployee,
// reactivateEmployee) — se mockea con la MISMA función para ambas: estos
// tests no necesitan distinguir qué mutation exacta de Convex se habría
// invocado en producción, solo que se llama con el userId correcto y en el
// momento correcto (con/sin confirmación previa).
